...
#define PRNFLAG( flagname ) \
	...
	PRNFLAG(TEXTUREFLAGS_PWL_CORRECTED)
	...
	PRNFLAG(TEXTUREFLAGS_DEFAULT_POOL)
	PRNFLAG(TEXTUREFLAGS_COMBINED)
	PRNFLAG(TEXTUREFLAGS_ASYNC_DOWNLOAD)
	PRNFLAG(TEXTUREFLAGS_NODEPTHBUFFER)
	PRNFLAG(TEXTUREFLAGS_SKIP_INITIAL_DOWNLOAD)
	PRNFLAG(TEXTUREFLAGS_CLAMPU)
	PRNFLAG(TEXTUREFLAGS_VERTEXTEXTURE)
	PRNFLAG(TEXTUREFLAGS_SSBUMP)
	PRNFLAG(TEXTUREFLAGS_MOST_MIPS)
